...
The following images are screenshots from exploring the fractals at varied depth. At the end of this section is an image of the user interface which explains the features and controls in full.
